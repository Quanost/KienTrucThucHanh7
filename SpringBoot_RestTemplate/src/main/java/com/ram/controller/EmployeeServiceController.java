...
public class EmployeeServiceController
{
	...
	public String createEmployee(@RequestBody Employee employee)
	{
		...
		ResponseEntity<String> responseEntity =  restTemplate
				.exchange("http://localhost:8087/employees", HttpMethod.POST, entity, String.class);
	...
	public String updateEmployee(@PathVariable("id") int id, @RequestBody Employee employee)
	{
		...
		ResponseEntity<String> responseEntity = restTemplate.exchange("http://localhost:8087/employees/" + id, HttpMethod.PUT,
				entity, String.class);
		return responseEntity.getBody();
	}
	...
	public String getEmployee(@PathVariable("id") int id)
	{
		...
		ResponseEntity<String> responseEntity = restTemplate
				.exchange("http://localhost:8087/employees/"+id, HttpMethod.GET, entity, String.class);
	...
	public String getEmployees()
	{
		...
		ResponseEntity<String> responseEntity = restTemplate
				.exchange("http://localhost:8087/employees", HttpMethod.GET, entity, String.class);
		return responseEntity.getBody();
	}
	...
	public String deleteEmployee(@PathVariable("id") int id)
	{
		...
		ResponseEntity<String> responseEntity = restTemplate.exchange("http://localhost:8087/employees/" + id, HttpMethod.DELETE,
				entity, String.class);
		return responseEntity.getBody();	
	}
